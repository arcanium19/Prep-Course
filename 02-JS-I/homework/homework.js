...
function elevar(num, exponent) {
  ...
  // Tu código:
  var elevarAB = Math.pow(num,exponent);
  return elevarAB;
}
...
function deEuroAdolar(euro){
  ...
  //Escribe tu código aquí
  var conversionmoneda=(euro*1.2)/1;
...
function esVocal(letra){
  ...
  if(letra.length==1){
    if(letra=="a"||letra=="e"||letra=="i"||letra=="o"||letra=="u"){
      ...
      var noesvo="Dato incorrecto"
      return noesvo;
    }
  }
  else{
    console.log("Dato incorrecto");
    var masde1="Dato incorrecto";
    return masde1;
  }
}
